...
class Mirasvit_Rewards_Model_Earning_Rule_Condition_Customer extends Mage_Rule_Model_Condition_Abstract
{
    ...
    const OPTION_IS_CONFIRMED = 'is_confirmed';
    ...
    public function loadAttributeOptions()
    {
        $attributes = array(
            ...
            self::OPTION_IS_CONFIRMED => Mage::helper('rewards')->__('Is confirmed'),
    ...
    protected function _prepareValueOptions()
    {
        ...
        if ($this->getAttribute() === self::OPTION_IS_SUBSCRIBER ||
            ...
            $this->getAttribute() === self::OPTION_IS_CONFIRMED) {
            $selectOptions = array(
    ...
    protected function validateCustomer(Varien_Object $customer)
    {
        ...
        $customer
            ...
            ->setData(self::OPTION_IS_CONFIRMED, !$customer->getData('confirmation'))

...
?>
<?php
class Apptha_Advancedreports_Block_Adminhtml_Advancedreports_Edit_Tab_Salesdatewise extends Mage_Adminhtml_Block_Widget_Form {

    // Assigning sales report template
    protected function _construct() {
        parent::_construct();
        $this->setTemplate('advancedreports/salesdatewise.phtml');
    }   

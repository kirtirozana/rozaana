...
?>
<?php
class Apptha_Advancedreports_Block_Adminhtml_Advancedreports_Edit_Tab_Gainer extends Mage_Adminhtml_Block_Widget_Form {

    // Assigning gainer report template
    protected function _construct() {
        parent::_construct();
        $this->setTemplate('advancedreports/gainer.phtml');
    }

    // Getting gainer report collection    
    public function advancedGainerProductsReportCollection($db_from, $db_to) {

 ...
 * @author      Magespacex Developer
 */
class Magespacex_Customercredit_CheckoutController extends Mage_Core_Controller_Front_Action
{
    ...
    public function setAmountPostAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if (is_numeric($request->getParam('credit_amount'))) {
                ...
                $moduleOnestepActive = Mage::getConfig()->getModuleConfig('Magespacex_Onestepcheckout')->is('active', 'true');
                $moduleWebposActive = Mage::getConfig()->getModuleConfig('Magespacex_Webpos')->is('active', 'true');

 ...
 * @author      Magespacex Developer
 */
class Magespacex_Customercredit_Helper_Data extends Mage_Core_Helper_Data
{
    ...
    {
        return Mage::getStoreConfig('advanced/modules_disable_output/Magespacex_Customercredit', $store);
    }
    ...
    public function canUseCode($code)
    {
        ...
        if (!($code instanceof Magespacex_Customercredit_Model_Creditcode)) {
            return false;
        }
        if (!$code->getId()) {
            return false;

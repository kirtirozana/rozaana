...
/**
 * Class Magespacex_Customercredit_Block_Adminhtml_Creditproduct_Tab_Storecredit
 */
class Magespacex_Customercredit_Block_Adminhtml_Creditproduct_Tab_Storecredit extends Mage_Adminhtml_Block_Widget_Form
                ...
                <script type="text/javascript">
                    ...
                    function hidesettingSC(){
                        ...
                        if($("storecredit_type").value == ' 
                            . Magespacex_Customercredit_Model_Storecredittype::CREDIT_TYPE_FIX . ')
                        {
                            ...
                            . Magespacex_Customercredit_Model_Storecredittype::CREDIT_TYPE_RANGE . ')
                        {
                            ...
                            . Magespacex_Customercredit_Model_Storecredittype::CREDIT_TYPE_DROPDOWN . ')
                        {
                            $("storecredit_value").disabled=true;
                            $("storecredit_from").disabled=true;
                            $("storecredit_to").disabled=true;

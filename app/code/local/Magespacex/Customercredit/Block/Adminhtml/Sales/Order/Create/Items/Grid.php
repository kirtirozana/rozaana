...
/**
 * Class Magespacex_Customercredit_Block_Adminhtml_Sales_Order_Create_Items_Grid
 */
class Magespacex_Customercredit_Block_Adminhtml_Sales_Order_Create_Items_Grid
        ...
        foreach ($items as $item) {
            ...
            if ($item->getProductType() == 'giftvoucher') {
                ...
                if ($baseCurrencyCode != $quoteCurrencyCode) {
                    ...
                    if ($product->getGiftType() == Magespacex_Giftvoucher_Model_Gifttype::GIFT_TYPE_RANGE) {

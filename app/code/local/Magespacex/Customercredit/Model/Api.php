 ...
 * @author      Magespacex Developer
 */
class Magespacex_Customercredit_Model_Api extends Mage_Api_Model_Resource_Abstract
{
    ...
    public function redeemCredit($customer, $creditcode)
    {
        ...
        if ($credit->getSize() == 0) {
            ...
            Mage::getModel('customercredit/creditcode')
                ->changeCodeStatus($credit->getFirstItem()->getId(), Magespacex_Customercredit_Model_Status::STATUS_ACTIVED);
            $credit_amount = $credit->getFirstItem()->getAmountCredit();
            Mage::getModel('customercredit/transaction')->addTransactionHistory($customer_id, Magespacex_Customercredit_Model_TransactionType::TYPE_REDEEM_CREDIT, "redeemcredit", "", $credit_amount);

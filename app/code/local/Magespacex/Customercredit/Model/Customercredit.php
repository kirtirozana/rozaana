 ...
 * @author      Magespacex Developer
 */
class Magespacex_Customercredit_Model_Customercredit extends Mage_Core_Model_Abstract
{
    ...
    public function sendCreditToFriendByEmail($credit_amount, $friend_email, $message, $customerId)
    {
        ...
        $code = $credit_code->addCreditCode($friend_email, $credit_amount, Magespacex_Customercredit_Model_Status::STATUS_UNUSED, $customerId);
     ...
     * 
     * @return Magespacex_Customercredit_Model_Customercredit
     */

<?php
/**
 * TSDesigns_MenuBuilder_Block_Adminhtml_Menu_Import_Form
 *
 * NOTICE OF LICENSE
 *
 ...
 *
 */
class TSDesigns_MenuBuilder_Block_Adminhtml_Menu_Import_Form 
...
/*    	
        $this->setChild('import',
            $this->getLayout()->createBlock('menubuilder/adminhtml_menu_import_form_tab_categories', 'import')
        );
*/    	
    	
        $this->setChild('tabs',
            $this->getLayout()->createBlock('menubuilder/adminhtml_menu_import_tabs', 'tabs')
        );
/*
        $this->setChild('node',
...
//        $params = array('section'=>'menubuilder');
    ...
    {
    	return Mage::helper('menubuilder')->__('Import');
    }

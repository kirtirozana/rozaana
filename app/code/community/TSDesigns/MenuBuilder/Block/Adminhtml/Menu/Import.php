<?php
/**
 * TSDesigns_MenuBuilder_Block_Adminhtml_Menu_Import
 *
 * NOTICE OF LICENSE
 *
 ...
 *
 */
class TSDesigns_MenuBuilder_Block_Adminhtml_Menu_Import extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        $this->_objectId    = 'entity_id';
        $this->_blockGroup	= 'menubuilder';
        $this->_controller  = 'adminhtml_menu';
        $this->_mode        = 'import';
	
        parent::__construct();
        $this->setTemplate('menubuilder/menu/import.phtml');
    }
}

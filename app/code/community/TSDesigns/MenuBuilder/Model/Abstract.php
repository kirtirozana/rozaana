<?php
/**
 * TSDesigns_MenuBuilder_Model_Abstract
 *
 * NOTICE OF LICENSE
 *
 ...
 *
 */
abstract class TSDesigns_MenuBuilder_Model_Abstract extends Mage_Core_Model_Abstract
{
    /**
    ...
    {
        /**
         * @deprecated since 1.4.0.0 stable
         */
        #if(version_compare(Mage::getVersion(), '1.4.0.0', '<')) {
        #    return isset($this->_defaultValues[$attributeCode]) ? $this->_defaultValues[$attributeCode] : false;
        #}

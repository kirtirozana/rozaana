<?php
/**
 * TSDesigns_MenuBuilder_Model_Resource_Eav_Mysql4_Menu_Tree
 *
 * NOTICE OF LICENSE
 *
 ...
 *
 */
class TSDesigns_MenuBuilder_Model_Resource_Eav_Mysql4_Menu_Tree extends Varien_Data_Tree_Dbp
{

	const CACHE_TAG = 'menubuilder_menu_tree';
    ...
    public function __construct()
    {
        ...
        parent::__construct(
            ...
            $resource->getTableName('menubuilder/menu'),
            array(
    ...
    public function addCollectionData($collection=null, $sorted=false, $exclude=array(), $toLoad=true, $onlyActive = false)
    {
        ...
        if ($onlyActive) {
            ...
            if ($this->_joinUrlRewriteIntoCollection) {
            	$collection->filterIsActiveAfterRewrite();
            } else {
            	$collection->addAttributeToFilter('is_active', 1);
            } */
        }
    ...
    protected function _initInactiveCategoryIds()
    {
        ...
        Mage::dispatchEvent('menubuilder_menu_tree_init_inactive_category_ids', array('tree'=>$this));
        return $this;
    }
    ...
    {
        Mage::dispatchEvent('menubuilder_menu_tree_move_before',
            array(
                'category' => $category,
    ...
    public function move($category, $newParent, $prevNode = null) {
        ...
        Mage::getResourceSingleton('menubuilder/menu')->move($category->getId(), $newParent->getId());
    ...
    {
        Mage::app()->cleanCache(array(TSDesigns_MenuBuilder_Model_Menu::CACHE_TAG));

        Mage::dispatchEvent('menubuilder_menu_tree_move_after',
            array(
                'category' => $category,
                'prev_node' => $prevNode,
                'parent' => $newParent
    ...
    protected function _createCollectionDataSelectOld($sorted = true, $optionalAttributes = array())
    {
        ...
        foreach ($attributes as $attributeCode) {
            $attribute = Mage::getResourceSingleton('menubuilder/menu')->getAttribute($attributeCode);
